...
def confirm(key_list, r, keys):
    test = []
    for i in range(10):
        l0 = (bin(random.randint(0, 2 ** 32))[2:]).zfill(32)
        c0 = encode(l0 + r, keys)
        test.append( (l0 + r, c0))
...
#attack((bin(int('eca86420', 16))[2:]).zfill(32), (bin(int('0f1571c947d9e859', 16))[2:].zfill(64)))
 ...
 ** Description:     输入数据
                     ...
                     cipher:  0xb9f81d5591998e98

                     message: 0x13579bdfeca86420
                     keys:    0x0f1571c947d9e859
                     cipher:  0x91026d57dd2b1751
 ****************************************************************************************"""